...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">(Please note that members will be logged out when attempting to access staff pages and staff will be automatically logged out when leaving staff pages.)</p>
        <p class="lead">
    ...
    <div class="row">
        <div class="col-md-4">
            <h2>Login</h2>
            <p>
                Login using the controls on the page below. You may need to create an account before you may use the web services. </p>
            <p>
        ...
        <div class="col-md-4">
            <h2>Access Staff Management Page</h2>
            <p>
                Use the control below to access the Staff Management page. Make sure that you login as a staff administrator (TA account info).
            </p>
            <p>
                If you navigate from the management page, you will automatically be logged out.</p>
            <p>
            ...
            <p>
                ...
                <asp:Button ID="staffButton" runat="server" OnClick="staffButton_Click" Text="Go to Staff Management Page" />
        ...
        <div class="col-md-4">
            ...
            <p>
                Use the control below to access the Staff page. Make sure that you login as a staff member.
            </p>
            <p>
                If you navigate from the staff page, you will automatically be logged out.</p>
            <p>
                <asp:Button ID="staffPageButton" runat="server" OnClick="staffPageButton_Click" Text="Go to Staff Page" />
            </p>
        </div>
    </div>
